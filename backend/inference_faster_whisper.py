...
from .subtitles import get_srt, get_vtt, write_file, get_txt, get_srt_wordlevel, apply_post_processing

from .asr_parameters import WhisperParameters
...
class FasterWhisperInference:
    ...
    def set_environment():
        ...
        cublas_bin_path = os.path.join(sys.prefix, 'Lib', 'site-packages', 'nvidia', 'cublas', 'bin')

        paths_to_add = [cudnn_bin_path, cublas_bin_path]
        ...
        logger.debug(f"[inference_faster_whisper.py] updated PATH with nvidia libs")
    ...
    def transcribe(self,
        ...
        if progress is not None: 
            progress(1, desc="Creating subtitles...")
        ...
        segments_result = apply_post_processing(segments_result, params)
