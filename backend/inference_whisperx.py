...
from .subtitles import apply_post_processing
...
class WhisperXInference:
    ...
    def set_environment():
        ...
        logger.debug(f"[inference_whisperx.py] updated PATH with nvidia libs")
    ...
    def transcribe(self,
        ...
        result["segments"] = apply_post_processing(result["segments"], params)
